...
Con questo approccio il sistema prova a suggerire automaticamente le corrispondenze più sensate, facendo risparmiare tempo e riducendo il lavoro manuale.

Non è perfetto, ma è stato molto interessante vedere quanto può avvicinarsi al modo in cui ragioniamo noi sulle parole. 😊

(ho usato PostgreSQL + Node.js per il backend e JavaScript per il frontend, per la parte di AI ho usato Tensorflowjs
